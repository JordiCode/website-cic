...
export const Hero = () => {
    return (
        <section className="max-w-7xl w-full mx-auto flex items-center  max-md:flex-col gap-24 max-md:gap-12 overflow-hidden px-3 py-36 max-md:py-12 relative mt-16 text-baseText">
            <div>
