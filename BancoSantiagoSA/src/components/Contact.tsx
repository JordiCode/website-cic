        ...
        <section className="mx-auto px-6 max-w-7xl w-full mt-24 max-md:mt-12">
            ...
            <form className="flex flex-col gap-6 rounded-3xl bg-secondaryText/1 px-12 py-16">
                <div className="flex flex-col gap-2">
                    <label htmlFor="cedula" className="text-lg text-primaryText">Número de Cedula <span className="text-red-400">*</span></label>
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="cedula" className="text-lg text-primaryText">Asunto <span className="text-red-400">*</span></label>
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="cedula" className="text-lg text-primaryText">Mensaje <span className="text-red-400">*</span></label>
                ...
                <button type="submit" className="self-start p-5 bg-accent rounded-md hover:scale-105 transition-transform text-lg text-primaryText">Enviar mensaje</button>
            </form>
        </section>
    )
}